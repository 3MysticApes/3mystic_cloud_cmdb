...
class cloud_cmdb_azure_client(base):
  def __init__(self, *args, **kwargs):
    ...
    data_action = __import__(f"threemystic_cloud_cmdb.cloud_providers.azure.client.actions.{processed_info['processed_data'].get('data_action')}", fromlist=['cloud_cmdb_azure_client_action'])
    process_data_action = getattr(data_action, 'cloud_cmdb_azure_client_action')(
